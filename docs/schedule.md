...
| W4  | **10/21**</br><div class="due"><p>📌 DUE: </p><ul><li>[Project 1](project-1.md)</li></ul></div><p>Project 1 Crit Day 1</p> | **10/23**</br><p>Project 1 Crit Day 2</p><div class="assign"><p>▶️ ASSIGN:</p><ul><li>[Reading/Media Response 3](reading-media.md/#reading-media-3) (Due: W6 Tue, 11/04)</li><li>[Project 2](project-2.md) (Due: W10 Tue, 12/02) and [Project 2 Proposal](project-2.md/#deliverables) (Due: W6 Thu, 11/06)</li></ul><p><i>If you're new to Blender and 3D modelling, try out this exercise before next Tuesday: </i></p><ul><li>Easy Froggy Blender Tutorial</li></ul><p><i>Once you're done, email me your final render to earn extra credit!</i></p></div></div>|
