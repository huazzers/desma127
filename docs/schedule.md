...
| W3  | **10/14**</br><div class="due"><p>📌 DUE:<p><ul><li>[Reading/Media Response 2](reading-media.md/#reading-media-2)</li></ul></div><p>Tutorial: Collision and Trigger Events, Scene management, Animation Events.</p><blockquote><p>Creating and linking to new scenes and timeline events</p></blockquote> | **10/16**</br><p>Tutorial: Sound and Scene Design Tips, Building your Project</p><p>Studio Time: Bring your work and questions to class!<p>|
